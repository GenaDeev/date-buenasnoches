export default function Eye({ type }) {
    let color;
    if (type === "blue") {
        color = '50d4d4';
    }
    ...
    return (
        <div className={`eye-${type}`}>
            <svg className="w-12 rounded-xl h-12 p-2 bg-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 280" style={{ enableBackground: 'new 0 0 280.028 280.028' }} xmlSpace="preserve">
