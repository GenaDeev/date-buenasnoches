    ...
    return (
        <article key={name.toLowerCase()} className="card flex flex-col w-[300px] h-[700px] bg-gray-200 hover:bg-gray-300 transition duration-200 justify-start">
            ...
            <div className="p-7 flex flex-col h-full">
                ...
                <Link className="p-2 mt-2 bg-pink-500 hover:bg-pink-400 hover:scale-105 active:scale-95 transition duration-200 rounded-xl text-white flex items-center gap-2" to={"/aplicar" + url}>
